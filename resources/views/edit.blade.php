...
<h2 style="text-align:center; margin-top:20px;" >Editar jugador:</h2>
<br></br>
        ...
        <td>
            ...
            @csrf @method('PATCH')
                <label>
                    ...
                    Nom del jugador: <input type="text" name="nombre" value="{{$id->nombre}}">
                    {!!$errors->first('nombre', '<small>El nombre es necesario</small>')!!}</br></br>
                    Nacionalitat del jugador: <input type="text" name="nacionalidad" value="{{$id->nacionalidad}}">
                    {!!$errors->first('nacionalidad', '<small>La nacionalidad es requerida</small>')!!}</br></br>
                    Dorsal del jugador: <input type="text" name="dorsal" value="{{$id->dorsal}}">
